...
@if(Session::get('role')=='Admin')
    ...
    <div><h2 style="background: #fff0f0;height: 50px">AdminPage<a href="{{url('logout')}}" style="margin-left: 1300px">logout</a></h2>
    </div>
...
@elseif(Session::get('role')=='NonAdmin')
    ...
    <div><h2 style="background: #fff0f0;height: 50px">EmployeePage<a href="{{url('logout')}}" style="margin-left: 1300px">logout</a></h2>
    </div>
@else
